          ...
          <div class="container-fluid d-flex justify-content-between">
            <nav class="pull-left">
              <!-- <ul class="nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#"> Tecno Web </a>
                </li>
                <li class="nav-item">
            ...
            <div class="copyright">
              2024, Tecno Web<i class="fa fa-heart heart text-danger"></i> by
              <a href="http://www.themekita.com">Ever Ochoa</a>
            </div>
            <div>
              Santa Cruz/
              <a target="_blank" >UAGRM</a>.
            </div>
          </div>
        </footer>
      </div>
